...
import { GoogleMapsAPI } from './components/url';
...
const NearbyPlaces = () => {
  ...
  const GOOGLE_API_KEY = GoogleMapsAPI;
      ...
      <View style={styles.header}>
        <View style={styles.boxContainer}>
          <View style={styles.box}>
            ...
            <Image source={require('./assets/map.png')} style={styles.boxImage} />
          </View>
          <View style={styles.box}>
            <View style={styles.boxContent}>
            ...
            <Image source={require('./assets/car.png')} style={styles.boxImage} />
          </View>
        </View>
      </View>
