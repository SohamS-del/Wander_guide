    ...
    const getUserData = async () => {
      try {
        ...
        if (storedUserData) {
          ...
          setUserSession(UserData); // Store parsed user data in state
    ...
    <View style={styles.myJourneyCard}>
      <View style={styles.myJourneyCardCont}> 
        <Text style={styles.myJourneyDate}>
          {"Created On " + journeyData?.journeyCreate  || "Journey Create Date not available"} | 
          {" Will Start On " + journeyData?.journeyStartDate || "Start Time not available"}
        </Text>  
